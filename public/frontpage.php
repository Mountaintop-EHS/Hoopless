<partial name="Page">
    ...
    <div class="hero-feature w-100" style="background-image:url('/assets/images/dimension/1260x630/offset/0,-20/hero/blue-mountains.jpg');">
        ...
        <aside class="info-box bg-warning p-4 d-none d-lg-block editable">
            <partial name="News">
                ...
                <div class="col-12 col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br/>
                            <a href="/help/phpmarkup" class="btn btn-warning mb-4">
                ...
                <div class="col-12 col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br/>
                            <a href="https://github.com/Ouxsoft/LuckByDice" class="btn btn-warning">
                                Learn More <span class="arrow-cta__icon" aria-hidden="true"></span>
                            </a>
                        </div>
                    </div>
